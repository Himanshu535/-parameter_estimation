...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        integer,parameter :: ts1=int(21600.0/1.0)
        integer,parameter :: ss1=int(10.0)
        real,parameter :: delta2= 0.2E-12*0.25*0.0 !Nutrient consumption for host
        ...
        real,parameter :: K_s =5.0/100.0 ! concentration of nutrient when thegrowth rate is half of its maximum value in mii molar.
        real ::cfl
        integer,parameter :: tnob=14,tnon=4
        real,parameter :: cap = 1.0E12, k1=1.0E07, k3=1.0E06,k9=5.0E06
        real,parameter :: ae=1000
        integer, parameter :: ub=4, lb=1,ub1=3,lb1=1
        real, parameter :: sc=7.0
        real, parameter  :: r1=0.05
        real, parameter :: fac=1.0
